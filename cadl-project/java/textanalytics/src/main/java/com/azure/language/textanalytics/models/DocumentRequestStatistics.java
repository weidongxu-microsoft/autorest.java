...
public final class DocumentRequestStatistics {
     ...
     */
    @JsonProperty(value = "documentsCount", required = true, access = JsonProperty.Access.WRITE_ONLY)
     ...
     */
    @JsonProperty(value = "validDocumentsCount", required = true, access = JsonProperty.Access.WRITE_ONLY)
     ...
     * non-supported languages documents.
     */
    @JsonProperty(value = "erroneousDocumentsCount", required = true, access = JsonProperty.Access.WRITE_ONLY)
    private long erroneousDocumentsCount;

    /*
     * Number of transactions for the request.
     */
    @JsonProperty(value = "transactionsCount", required = true, access = JsonProperty.Access.WRITE_ONLY)
    ...
    public DocumentRequestStatistics(
            @JsonProperty(value = "documentsCount", required = true, access = JsonProperty.Access.WRITE_ONLY)
                    long documentsCount,
            @JsonProperty(value = "validDocumentsCount", required = true, access = JsonProperty.Access.WRITE_ONLY)
                    long validDocumentsCount,
            @JsonProperty(value = "erroneousDocumentsCount", required = true, access = JsonProperty.Access.WRITE_ONLY)
                    long erroneousDocumentsCount,
            @JsonProperty(value = "transactionsCount", required = true, access = JsonProperty.Access.WRITE_ONLY)
